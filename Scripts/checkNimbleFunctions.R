...
manualCheck1 <- mean(testVector[open:floor(open-duration)])

# run hard coded just to check 'ceiling' is doing what I expect
manualManualCheck1 <- mean(testVector[10:(10-5)])
...
# run it with the manual part pull out
manualCheck2 <- mean(testVector[open:floor(open-duration)])
manualCheck2b <- mean(testVector[open:floor(open-duration)])

# run hard coded just to check 'ceiling' is doing what I expect
manualManualCheck2 <- mean(testVector[10:4])
manualManualCheck2b <- mean(testVector[10:4])

test2 - manualCheck2 # 0: CHECK PASSED 08.07.26
test2b - manualCheck2b # 0: CHECK PASSED 08.07.26

test2 - manualManualCheck2 # 0: CHECK PASSED 08.07.26
test2b - manualManualCheck2b # 0: CHECK PASSED 08.07.26

### Test 3: correct mean: integer duration but not open? ####

duration <- 5
open <- 10.3 # one <0.5 over
open2 <- 10.8 # one >0.5 over
...
# run it with the manual part pull out
manualCheck3 <- mean(testVector[trunc(open):floor(open-duration)])
manualCheck3b <- mean(testVector[trunc(open):floor(open-duration)])

# run hard coded just to check 'ceiling' is doing what I expect
manualManualCheck3 <- mean(testVector[10:5])
manualManualCheck3b <- mean(testVector[10:5])

test3 - manualCheck3 # 0: CHECK PASSED 08.07.26
test3b - manualCheck3b # 0: CHECK PASSED 08.07.26

test3 - manualManualCheck3 # 0: CHECK PASSED 08.07.26
test3b - manualManualCheck3b # 0: CHECK PASSED 08.07.26
...
# run it with the manual part pull out
manualCheck4 <- mean(testVector[trunc(open):floor(open-duration)])
manualCheck4b <- mean(testVector[trunc(open2):floor(open2-duration2)])

# run hard coded just to check 'ceiling' is doing what I expect
manualManualCheck4 <- mean(testVector[10:4])
manualManualCheck4b <- mean(testVector[10:5])

test4 - manualCheck4 # 0: CHECK PASSED 08.07.26
test4b - manualCheck4b # 0: CHECK PASSED 08.07.26

test4 - manualManualCheck4 # 0: CHECK PASSED 08.07.26
test4b - manualManualCheck4b # 0: CHECK PASSED 08.07.26

#### Testing weightedMeanNimble ################################################

### Test 1: does it calculate the correct mean: equal weights ####

values <- testVector[10:5]
weights <- rep(1, 6)
...
test1.1 - manualCheck1.1 # 0: CHECK PASSED 08.07.26

test1.1 - manualManualCheck1.1 # 0: CHECK PASSED 08.07.26
...
test2.1 - manualCheck2.1 # 0: CHECK PASSED 08.07.26
test2.1b - manualCheck2.1b # 0: CHECK PASSED 08.07.26

test2.1 - manualManualCheck2.1 # 0: CHECK PASSED 08.07.26
test2.1b - manualManualCheck2.1b # 0: CHECK PASSED 08.07.26
...
test3.1 - manualCheck3.1 # 0: CHECK PASSED 08.07.26
test3.1b - manualCheck3.1b # 0: CHECK PASSED 08.07.26

test3.1 - manualManualCheck3.1 # 0: CHECK PASSED 08.07.26
test3.1b - manualManualCheck3.1b # 0: CHECK PASSED 08.07.26
...
# run it with the manual part pull out
manualCheck1.3 <- mean(testVector[trunc(open):floor(open-duration)])

# run hard coded just to check 'ceiling' is doing what I expect
manualManualCheck1.3 <- sum(testVector[10:(10-5)])/6

# compare to weighted mean function
weightedCheck1.3 <- weighted.mean(x = testVector[10:(10-5)],
                                  weights = rep(1,6))

test1.3 - manualCheck1.3 # 0. CHECK PASSED 08.07.26

# sense check
manualCheck1.3 - manualManualCheck1.3 # 0. CHECK PASSED 08.07.26

test1.3 - manualManualCheck1.3 # 0: CHECK PASSED 08.07.26

test1.3 - weightedCheck1.3 # 0: CHECK PASSED 08.07.26
...
# run it with the manual part pull out
manualCheck2.3 <- weighted.mean(x = testVector[trunc(open):floor(open-duration)],
                                w = c(rep(1, 6), (open-duration - trunc(open-duration))))
manualCheck2.3b <- weighted.mean(x = testVector[trunc(open):floor(open-duration2)],
                                 w = c(rep(1, 6), (open-duration2 - trunc(open-duration2))))
...
# run it with the manual part pull out
manualCheck3.3 <- weighted.mean(x = testVector[trunc(open):floor(open-duration)],
                                w = c(1-(open-trunc(open)),
                                      rep(1, 4), 
                                      ((open-duration)-trunc(open-duration))))
manualCheck3.3b <- weighted.mean(x = testVector[trunc(open2):floor(open2-duration)],
...
# run it with the manual part pull out
manualCheck4.3 <- weighted.mean(x = testVector[trunc(open):floor(open-duration)],
                                w = c(1-(open-trunc(open)),
                                      rep(1, 5), 
                                      ((open-duration)-trunc(open-duration))))
manualCheck4.3b <- weighted.mean(x = testVector[trunc(open2):floor(open2-duration2)],
                                 w = c(1-(open2-trunc(open2)),
                                       rep(1, 4),
                                       ((open2-duration2)-trunc(open2-duration2))))
